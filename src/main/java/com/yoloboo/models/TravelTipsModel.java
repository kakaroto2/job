 ...
 */
public class TravelTipsModel extends CmsContentModel implements Serializable
{
    private Long id;
    ...
    public Long getCountryTipsId() {
        return countryTipsId;
    }

    public void setCountryTipsId(Long countryTipsId) {
        this.countryTipsId = countryTipsId;
    }
